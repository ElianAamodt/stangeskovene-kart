(function (window, document) {
  ...
  var periods = [
    { id: "smarovdyr", name: "Smårovdyr", start: [1, 1], end: [4, 15], range: "1. januar–15. april", text: "Kortet dekker flere arter og områder. Artsvise jakttider gjelder.", url: "/smarovdyrkort" },
    { id: "taksering", name: "Skogsfugltaksering", start: [8, 8], end: [8, 21], range: "Normalt 8.–21. august", text: "Årlig taksering med hundefører og observatør. Nye taksører kan melde interesse.", url: "/skogsfugltaksering" },
    { id: "rabukk", name: "Råbukk", start: [8, 10], end: [9, 9], range: "10. august–9. september", text: "Et begrenset antall kort for arealer i Aurskog-Høland og Nes.", url: "/jakt-etter-rabukk" },
    { id: "baronskogen", name: "Elgjakt på Baronskogen", start: [9, 25], end: [12, 23], range: "25. september–23. desember", text: "Tilrettelagt gjestejakt med hund på Baronskogen i Nes.", url: "/tilrettelagt-elgjakt-pa-baronskogen" }
  ];
